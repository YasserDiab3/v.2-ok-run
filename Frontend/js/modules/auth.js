        ...
        if (!user && foundUser) {
            ...
            if (users.length === 0) {
                ...
                if (!foundUser && users.length === 0) {
                    ...
                    if (canSyncUsers) {
                        msg += 'يرجى التحقق من:\n';
                        msg += '1. إعدادات Google Apps Script (هل السكربت منشور؟)\n';
                        msg += '2. معرف Google Sheets في الإعدادات\n';
                        msg += '3. الاتصال بالإنترنت\n';
                        msg += '4. أن ورقة Users في Google Sheets تحتوي على مدير واحد على الأقل مع passwordHash صحيح.';
                    } else {
                        msg += 'يرجى التأكد من تفعيل Google Apps Script وإعداد Google Sheets.\n';
                        msg += 'أو إضافة مستخدمين من خلال الإعدادات.';
                    }
