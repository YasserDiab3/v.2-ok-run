...
| **فشل تسجيل الدخول: البريد أو كلمة المرور غير صحيحة** | 1) اضغط **إعداد المزامنة** في شاشة الدخول وأدخل رابط نشر Google Apps Script (ينتهي بـ `/exec`). 2) في Google: نشر التطبيق كـ Web App واختر **من له حق الوصول: أي شخص**. 3) للتجربة الأولى استخدم **admin@hse.local** وكلمة المرور **admin123**. |
