...
function getDefaultHeaders(sheetName) {
    const headersMap = {
        ...
        'ContractorTrainings': ['id', 'contractorId', 'contractorName', 'trainingName', 'trainer', 'date', 'participants', 'topics', 'location', 'locationId', 'subLocation', 'subLocationId', 'notes', 'status', 'createdAt', 'updatedAt'],
